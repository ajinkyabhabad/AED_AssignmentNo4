...
public class OrderDetailsJPanel extends javax.swing.JPanel {
    ...
    public OrderDetailsJPanel(JPanel userProcessContainer,EcoSystem ecosystem,UserAccount account, LabTestWorkRequest workRequest) {
        initComponents();
    ...
    private void display(){
        ...
        if(workRequest.getDeliverMan()!= null){
            deliveryManName.setText(workRequest.getDeliverMan().getDeliveryManName());
        }else
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        // TODO add your handling code here:
            CustomerAreaJPanel orderStatusJPanel = new CustomerAreaJPanel(userProcessContainer,ecosystem, account);
