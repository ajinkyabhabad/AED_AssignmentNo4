...
public class OrderRequestDetailsJPanel extends javax.swing.JPanel {
    ...
    UserAccount account;
    EcoSystem ecosystem;
    LabTestWorkRequest workRequest;
    double total = 0.0;
    private DefaultTableModel orderTable;
    private DeliveryManDirectory deliveryManDirectory;
    private int index = -1;

    public OrderRequestDetailsJPanel(JPanel userProcessContainer, EcoSystem ecosystem, UserAccount account, LabTestWorkRequest workRequest) {
        initComponents();
    ...
    private void display() {
        ...
        restaurantName.setText(workRequest.getRestaurant().getRestaurantName());
        ...
        for (ItemQuantity itemWithQuantity : workRequest.getItemsWithQuatityList()) {
    ...
    private void btnBack1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBack1ActionPerformed
        ...
        RestaurantOrderDetailsJPanel manageOrderJPanel = new RestaurantOrderDetailsJPanel(userProcessContainer,ecosystem, account);
        ...
        if (workRequest.getStatus().equals("Ordered")) {
            ...
            JOptionPane.showMessageDialog(null, " Order Accepted Successfully!!, Please assign delivery person");
             ...
             if(workRequest.getDeliverMan() == null){
                 ...
                 JOptionPane.showMessageDialog(null, "Delivery person will pick up the order in sometime");
                 //workRequest.setDeliverMan(deliveryManNameValue.getText());
             }
