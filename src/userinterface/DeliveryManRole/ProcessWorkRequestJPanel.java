...
public class ProcessWorkRequestJPanel extends javax.swing.JPanel {
     ...
     */
    public ProcessWorkRequestJPanel(JPanel userProcessContainer, EcoSystem ecosystem, UserAccount account, LabTestWorkRequest workRequest) {
        initComponents();
    ...
    private void btnStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStatusActionPerformed
        if (workRequest.getStatus().equals("Prepared")) {
            ...
            workRequest.setTestResult("In-progress");
